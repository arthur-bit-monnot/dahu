...
object Computation {
  ...
  def apply[I1,I2,O : TypeTag](f: Fun2[I1,I2,O], in1: Expr[I1], in2: Expr[I2]): Computation2[I1,I2,O] = Computation2(f, in1, in2)
  def apply[I1,I2,I3,O : TypeTag](f: Fun3[I1,I2,I3,O], in1: Expr[I1], in2: Expr[I2], in3: Expr[I3]): Computation3[I1,I2,I3,O] = Computation3(f, in1, in2, in3)
}
final case class Computation1[I,O : TypeTag](fun1: Fun1[I,O], in: Expr[I]) extends Expr[O]
final case class Computation2[I1,I2,O : TypeTag](fun1: Fun2[I1,I2,O], in: Expr[I1], in2: Expr[I2]) extends Expr[O]
final case class Computation3[I1,I2,I3,O : TypeTag](f: Fun3[I1,I2,I3,O], in: Expr[I1], in2: Expr[I2], in3: Expr[I3]) extends Expr[O]
