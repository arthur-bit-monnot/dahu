...
class Test extends FreeSpec {
  ...
  object StringCol {
    implicit val col: Column.Aux[StringCol.type, String] =
      new Column[StringCol.type] { type Field = String }
  }

  object IntCol {
    implicit val col: Column.Aux[IntCol.type, Int] = new Column[IntCol.type] {
      type Field = Int
    }
  }
