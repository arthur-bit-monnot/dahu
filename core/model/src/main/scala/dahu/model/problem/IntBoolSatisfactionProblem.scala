...
//    require(value.typ.isBoolean)
//  }
//
//  case class CompatibleInput[K](value: InputF[K], t: RawInt) extends CellOpt[K] {}
//
...
//  }
//
//  case class CompatibleConstant[K](value: CstF[K], t: RawInt) extends CellOpt[K] {
...
//      case x @ CstF(v, t: RawInt) =>
//        CompatibleConstant(x, t)
