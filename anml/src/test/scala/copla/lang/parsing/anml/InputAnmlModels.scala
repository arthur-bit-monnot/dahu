...
object InputAnmlModels {
  ...
  val valid = Seq(
    ...
    "type A; type B; fluent A f(B b); instance A a1; instance B b1; [start,end] contains f(b1) == a1;",
    "type A; type B; fluent A f(B b); instance A a1; instance B b1; [start] contains f(b1) := a1;",
    "type A; type B; fluent A f(B b); instance A a1; instance B b1; [start,end] contains id: f(b1) == a1; [start+10, 20] contains { f(b1) == a1; f(b1) == a1; };",
    ...
    "constant boolean x(boolean arg); x(true) := true;",
