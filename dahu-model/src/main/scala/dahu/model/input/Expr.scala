...
final case class Product[T[_[_]], V <: T[Expr]](value: V)(implicit tt: WTypeTag[T[Id]],
...
final case class Computation2[I1, I2, O: WTypeTag](f: Fun2[I1, I2, O], in: Expr[I1], in2: Expr[I2])
